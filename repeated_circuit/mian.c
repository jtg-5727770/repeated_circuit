...
int main(void)
{
	//그래프 그리기
	GraphType g = { 10,
	{{ 0, 3, INF, INF, INF, INF, 11, 12, INF, INF },
	{ 3, 0, 5, 4, 1, 7, 8, INF, INF, INF, INF, INF },
	{ INF, 5, 0, 2, INF, INF, 6, 5, INF, INF, INF },
	{ INF, 4, 3, 0, 13, INF, INF, 14, INF, 16, INF },
	{ INF, 1, INF, 13, 0, 9, INF, INF, 18, INF },
